        ...
        <>
            ...
            <div className="Home">
                ...
                <div className={heading ? "HomeContent" : "HomeContent hide"}>
                    ...
                    >
                        "Developed and Maintained by Team Codebreakers"
                    </AnimatedText>
                </div>
            ...
            <div className="Suggestion">
                <div className="group">
                    ...
                    <div className="des">Send us book name and author name to add</div>
                </div>
                <div className="group">
            ...
            <div className="Footer">
                ...
                {/* <div className="Logo"><img src={logo} alt="" /></div> */}
                <div className="text">We are trying our best to make the website user friendly, If you have any problem and query then contact us by the social handle given. <br /><span>-Pruthiraj & Team</span></div>
                <div className="SocialGrp">
                    ...
                    <a href="#">pruthiraj2002routray@gmail.com</a>
                </div>
            </div>
        </>
    )
